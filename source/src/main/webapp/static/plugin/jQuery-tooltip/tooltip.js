...
var tooltip = function (B) {
    ...
    var f = "length", Eb = "addEventListener", ab, oc, Nb = function () {
        ...
        if (a[Eb])a[Eb](c, b, false); else a.attachEvent && a.attachEvent("on" + c, b)
    }, a = {}, V = function (a) {
        ...
        return c
    }, Y = {a: 0, b: 0}, g = null, gc = function (a) {
        if (!a)a = window.event;
        Y.a = a.clientX;
        Y.b = a.clientY
    }, ec = function (a) {
        if (window.getComputedStyle)var b = window.getComputedStyle(a, null); else if (a.currentStyle)b = a.currentStyle; else b = a[d];
        return b
        ...
        this.a = [];
        this.b = null
    }, O = "firstChild", ub = 0, m = document, T = "getElementById", W = navigator, P = "innerHTML", o = function (a, b) {
        return b ? m[a](b) : m[a]
    }, E = {}, Gb = function () {
        var c = 50, b = W.userAgent, a;
        if ((a = b.indexOf("MSIE ")) != -1)c = parseInt(b.substring(a + 5, b.indexOf(".", a)));
        return c
    }, tb = Gb() < 9, xb = !!W.msMaxTouchPoints, lb = !!("ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch), Kb = (W.msPointerEnabled || W.pointerEnabled) && xb;
    ...
    }, nc = "marginTop", kc = "marginLeft", r = "offsetWidth", t = "offsetHeight", sb = "documentElement", mc = "borderColor", pb = "nextSibling", d = "style", z = "width", y = "left", s = "top", H = "height", ic = ["$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22"], x, mb, C = function (c, a, b) {
    ...
    var fb = new Jb, h = function (d, b, c, e, a) {
        fb.j(d, b, c, e, a)
    }, hc = [/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/, /.*([\w\-])\.(\w)(\w)\.[^.]+$/, /^(?:.*\.)?(\w)(\w)\.[^.]+$/, /.*([\w\-])([\w\-])\.com\.[^.]+$/, /^(\w)[^.]*(\w)$/], ib = function (d, a) {
        var c = [];
        if (ub)return ub;
        ...
        if (a) {
            a.op = b;
            if (tb)a[d].filter = "alpha(opacity=" + b * 100 + ")"; else a[d][I] = b
        }
            ...
            n.onreadystatechange = function () {
                if (n && n.readyState === 4) {
                    ...
                    if (n.status === 200) {
                        if (l == d && R) {
                            q();
                            var j = c.toLowerCase() == "xml" ? n.responseXML : n.responseText, k = j;
        ...
        E.a = bc();
        if (E.a) {
            var a = "#mcttCloseButton", b = "position:absolute;left:auto;cursor:pointer;top:" + B[L] + "px;right:" + B[L] + "px;";
    ...
    Lb.prototype = {
        j: function () {
            ...
            if (c.v) {
                ...
                if (a.e > 4)h(c, s, f.t + 6, f.t); else c[d][s] = f.t + "px";
                c[d][y] = f.l + "px";
                b[d][z] = b.tw + "px";
                b[d][H] = b.th + "px";
                i[d][y] = f.x + "px";
            ...
            if (h)if (a.e < 4)this.j(); else j(i, 0)
        }, k: function () {
            ...
            var q = b.tw + a.l + a.b + a.b, p = b.th + a.m + a.b + a.b, l = this.p(g, q, p);
            if (g.smartPosition)var d = Ub(q + a.f, p + a.f, l.x, l.y); else d = {l: l.x, t: l.y};
            var h = g[Q], m = this.u(h, g[Fb], q, p);
            if (g.smartPosition && h < 4) {
                var v = d.l - l.x, w = d.t - l.y;
                if (h == 0 || h == 2)m[0] -= v; else v && j(i, 0);
                if (h == 1 || h == 3)m[1] -= w; else w && j(i, 0)
            }
            if (k == x) {
                var u = Yb();
                d.l = d.l + u[0];
            ...
            if (o < 4)if (b.nodeType != 1)c = d = h = g = 0; else if (b.relativeTo == "mouse") {
                c = Y.a;
                d = Y.b;
                if (Y.a == null) {
                    c = p(b, 0) + w(b[r] / 2);
            ...
            return {x: c + q + b.offsetX, y: d + s + b.offsetY}
        }, u: function (f, c, e, d) {
            j(i, f < 4);
            var b = [0, 0];
            switch (f) {
