...
(function ($) {
    ...
    $.fn.BootSideMenu = function (userOptions) {
        ...
        menu.on("click", "a.list-group-item", function (E) {
            ...
            // todo
            // 阻止事件冒泡 add@zuoyx 20170121
            // e.stopPropagation();
            throw "e.stopPropagation";
        });
        ...
        function startClosed() {
            if (options.side == "left") {
                ...
                menu.hide().animate({
                    ...
                    $("body").animate({marginLeft: (parseInt(body.originalMarginLeft.substring(0, body.originalMarginLeft.indexOf("px"))) + 20) + "px"}, {duration: 0});
                    menu.show();
                    switchArrow("left");
                });
            } else if (options.side == "right") {
        ...
        function closeMenu(execFunctions) {
            ...
            if (options.side == "left") {
                ...
                if (options.pushBody) {
                    ...
                    $("body").animate({marginLeft: (parseInt(body.originalMarginLeft.substring(0, body.originalMarginLeft.indexOf("px"))) + 20) + "px"}, {duration: options.duration});
                }
